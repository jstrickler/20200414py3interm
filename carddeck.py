...
"""
import random
from carddeckbase import CardDeckBase

def other_method():
    """
    Just your average utility method

    :return:
    """
    print("other...")

class CardDeck(CardDeckBase):
    """
    ...
    # CAUTION!!
    # def probably_shouldnt_do_this(self):
    #     self.RANKS.append('X')

    @staticmethod
    def say_hello():
        """
        Utility function to greet the user
